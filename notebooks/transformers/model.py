...
Original file is located at
    https://colab.research.google.com/drive/1zNZHMwFs3KCkgTik7yqoemBRAAhaD1Av
"""
...
class LayerNormalization(nn.Module):
    def __init__(self,eps:float=10**-6) -> None:
        super().__init__()
        self.eps = eps # used below to prevent dividing by zero error or when std is very small
        self.alpha = nn.Parameter(torch.ones(1)) # alpha is a learnable parameter
        self.bias = nn.Parameter(torch.ones(1)) # bias is a leanable parameter
    def forward(self,x):
        # x: (batch_len, seq_len, hidden_size)
...
class InputEmbeddings(nn.Module):
    def __init__(self,d_model: int, vocab_size: int):
        ...
        self.vocab_size = vocab_size # Total number of words in the corpus
